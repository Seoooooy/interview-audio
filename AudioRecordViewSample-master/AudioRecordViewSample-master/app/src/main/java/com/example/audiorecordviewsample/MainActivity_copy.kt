...
open class MainActivity_copy : AppCompatActivity()  {
/*
...
//        var data=  DetectNoise()
//        data.start()

        //val decibelisLiveData = DecibelsLiveData()

        //textView1.decibelsLiveData
        //}
        ...
        setSwitchListeners()
        //textView1.text = DecibelsLiveData().toString()
    ...
    private fun startRecording() {
        ...
        try {
            ...
            Log.e(MainActivity_copy::class.simpleName, e.message ?: e.toString())
            return
        }
